 ...
 */
export function reducer(state: State = initialState, action: trendsAction.Actions | apiAction.Actions): State {
	switch (action.type) {
		case trendsAction.ActionTypes.SEARCH_TRENDING_HASHTAGS: {
		...
		case apiAction.ActionTypes.SEARCH_TRENDING_HASHTAGS_SUCCESS:
