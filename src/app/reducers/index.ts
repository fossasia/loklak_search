...
export const getMediaWallColor = createSelector(getMediaWallState, fromMediaWall.getMediaWallColor);
export const getMediaElements = createSelector(getMediaWallState, fromMediaWall.getMediaElements);
